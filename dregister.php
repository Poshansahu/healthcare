...
.btn {        
	...
	if($num == 0) {
        if($password == $cpassword) {
          $q = "insert into doctor values('','$fullname','$email_id','$primary_contact_number','$secondary_contact_number','$address','$adharcard_number','$pancard_number','$joining_date','$speciality_id','$visit_time_from','$visit_time_to','$created_date','$username','$password','1')";
...
<div class="login-form">
	<form method="post">
        <h2 class="text-center">Register Doctors</h2>  
        ...
        <div class="form-group">
		   ...
		   <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
		    <input type="text" class="form-control" placeholder="Email Id" name="email_id" required="required">
		</div>
		   </div>
		</div>		
        ...
        <div class="form-group">
		  ...
		  <input type="time" name="visit_time_from" class="form-control">
		</div>
		   </div>
		   <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
          <label for="visit_time_to">To</label>
		  <input type="time" name="visit_time_to" class="form-control">
		</div>
		   </div>
		</div>
